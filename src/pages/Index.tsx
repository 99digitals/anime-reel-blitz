    ...
    <div className="min-h-screen">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-2' : 'py-4'}`}>
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <Button 
            className="bg-anime-orange hover:bg-anime-orange/90 text-white"
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                className="bg-anime-purple hover:bg-anime-purple/90 text-white px-8 py-6 text-lg"
                onClick={() => window.open("https://shop.worklinc.com/product/1800-anime-reels-bundle/", "_blank")}
              >
                Get The Bundle
              </Button>
              ...
              <Button 
                variant="outline" 
                className="border-anime-purple text-anime-purple hover:text-anime-purple/90 px-8 py-6 text-lg"
            ...
            <div className="mt-8 flex items-center justify-center lg:justify-start">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-anime-purple flex items-center justify-center text-white text-xs border-2 border-white">
                    {i}
                  </div>
                ))}
              </div>
          ...
          <div className="relative">
            <div className="bg-white p-3 rounded-3xl shadow-xl max-w-md mx-auto">
              <div className="relative rounded-2xl overflow-hidden aspect-square">
                <img
                  src="https://shop.worklinc.com/wp-content/uploads/2025/04/WorkLinc.in-1515.mp4"
      ...
      <section className="py-20 px-4 bg-anime-purple text-white">
        <div className="container mx-auto text-center">
          ...
          <Button 
            className="bg-white text-anime-purple hover:bg-gray-100 px-8 py-6 text-lg font-bold"
            onClick={() => window.open("https://shop.worklinc.com/product/1800-anime-reels-bundle/", "_blank")}
          >
